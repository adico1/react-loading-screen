...
(function () {
  ...
  reactHotLoader.register(ScreenWrapper, 'ScreenWrapper', 'src/index.js');
  reactHotLoader.register(LoadingComponents, 'LoadingComponents', 'src/index.js');
  reactHotLoader.register(LoadableData, 'LoadableData', 'src/index.js');
  reactHotLoader.register(propTypes, 'propTypes', 'src/index.js');
  reactHotLoader.register(LoadingScreen, 'LoadingScreen', 'src/index.js');
